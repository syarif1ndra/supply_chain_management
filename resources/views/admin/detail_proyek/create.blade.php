    ...
    <div class="container">
        ...
        <div class="card shadow-lg" style="width: 40rem; margin: auto;">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.detail_proyek.store', ['proyek_id' => $proyek_id]) }}" method="POST" id="formDetailProyek">
                    @csrf
                        ...
                        <select name="material_id" id="material_id"
                            ...
                            @foreach ($material_proyek as $material)
                                <option value="{{ $material->id }}"
                                    data-harga="{{ $material->harga_satuan }}"
                    ...
                    <!-- Tombol Submit -->
                    <div class="d-grid">
                        <button type="submit" class="btn bg-gray-500 text-white" id="submitBtn">Tambah Detail Proyek</button>
                    </div>
                </form>
...
<div class="modal fade" id="stokTidakMencukupiModal" tabindex="-1" aria-labelledby="stokTidakMencukupiModalLabel" aria-hidden="true">
...
@section('scripts')
<script>
// Fungsi untuk menghitung biaya dan memvalidasi jumlah yang digunakan
...
function updateBiaya() {
    ...
    // Validasi jika jumlah yang digunakan lebih besar dari stok
    if (jumlahDigunakan > stok) {
        document.getElementById('biaya_penggunaan').value = '';
        document.getElementById('jumlah_digunakan').setCustomValidity(`Jumlah yang digunakan tidak boleh lebih besar dari stok (${stok})`);
        ...
        document.getElementById('jumlah_digunakan').setCustomValidity(''); // Reset jika valid
